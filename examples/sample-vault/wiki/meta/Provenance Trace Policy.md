...
Provenance trace rule: goal to reference to rubric to artifact to critic verdict to revision to regression gate to acceptance claim. Connect source, claim, note, decision, tool output, and deliverable so final answers can be audited.
