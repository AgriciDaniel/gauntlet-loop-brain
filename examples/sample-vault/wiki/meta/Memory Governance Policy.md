...
Memory governance rule: preserve decisions, evidence, dissent, cost, and failures; do not persist secrets or unsupported conclusions; support explicit rollback and forgetting. Persistent memory must define write, store, retrieve, execute, share, forget, and rollback behavior before mutation is allowed.
