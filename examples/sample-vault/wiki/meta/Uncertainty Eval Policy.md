...
Uncertainty eval rule: reward no data, dissent, and escalation; penalize unsupported certainty, hidden regressions, proxy gaming, and aspirational claims presented as achieved. Evals should reward no data when evidence is absent and penalize confident unsupported answers.
