# Gauntlet Loop Brain Agent Instructions
...
8. `agents/gauntlet-loop-secretary.md`
...
- For grounded answers or vault maintenance, use `agents/gauntlet-loop-secretary.md`.
