...
Answer-engine policy: answer from supplied primary-source notes, distinguish fact from inference, and return no data when the evidence is missing. Public passages should be useful, crawlable, source-clear, and free of tricks.
