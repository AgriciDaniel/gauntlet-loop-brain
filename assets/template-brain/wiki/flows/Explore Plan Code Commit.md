...
- Confirm the task is advisory and read-only under advisory by default; ordinary reversible workspace edits only when the user asks to build or fix; no external or irreversible action without exact approval.
